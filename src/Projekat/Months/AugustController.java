...
public class AugustController extends MonthController {
    ...
    public void nxtMonth(MouseEvent mouseEvent) throws IOException {
        ...
        monthInterface.nextMonth("September.fxml", toField, current,septemberController);
    }

    public void pvsMonth(MouseEvent mouseEvent) throws IOException {
        JulyController julyController = new JulyController(current);
        monthInterface.previousMonth("July.fxml", toField, current, julyController);
    }
    ...
    public void btnPressed(ActionEvent actionEvent) {
        ...
        if(!reservedNumbers.isEmpty()) {
            ...
            LocalDate fromDate = LocalDate.of(2020, Month.AUGUST, min);
            LocalDate toDate = LocalDate.of(2020, Month.AUGUST, max);

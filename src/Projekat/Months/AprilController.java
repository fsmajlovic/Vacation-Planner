...
public class AprilController extends MonthController {
    ...
    public AprilController(User current){
    ...
    public void nxtMonth(MouseEvent mouseEvent) throws IOException {
        ...
        monthInterface.nextMonth("May.fxml", toField, current,mayController);
    }

    public void pvsMonth(MouseEvent mouseEvent) throws IOException {
        MarchController marchController = new MarchController(current);
        monthInterface.previousMonth("March.fxml", toField, current, marchController);
    }
    ...
    public void btnPressed(ActionEvent actionEvent) {
        ...
        if(!reservedNumbers.isEmpty()) {
            ...
            LocalDate fromDate = LocalDate.of(2020, Month.APRIL, min);
            LocalDate toDate = LocalDate.of(2020, Month.APRIL, max);

...
public class SeptemberController extends MonthController {
    ...
    public SeptemberController(User current){
    ...
    public void nxtMonth(MouseEvent mouseEvent) throws IOException {
        ...
        monthInterface.nextMonth("October.fxml", toField, current,octoberController);
    }

    public void pvsMonth(MouseEvent mouseEvent) throws IOException {
        AugustController augustController = new AugustController(current);
        monthInterface.previousMonth("August.fxml", toField, current, augustController);
    }
    ...
    public void btnPressed(ActionEvent actionEvent) {
        ...
        if(!reservedNumbers.isEmpty()) {
            ...
            LocalDate fromDate = LocalDate.of(2020, Month.SEPTEMBER, min);
            LocalDate toDate = LocalDate.of(2020, Month.SEPTEMBER, max);

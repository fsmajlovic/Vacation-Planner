...
public class DecemberController extends MonthController {
    ...
    public DecemberController(User current){
    ...
    public void pvsMonth(MouseEvent mouseEvent) throws IOException {
        ...
        monthInterface.previousMonth("November.fxml", toField, current, novemberController);
    }
    ...
    public void btnPressed(ActionEvent actionEvent) {
        ...
        if(!reservedNumbers.isEmpty()) {
            ...
            LocalDate fromDate = LocalDate.of(2020, Month.DECEMBER, min);
            LocalDate toDate = LocalDate.of(2020, Month.DECEMBER, max);
